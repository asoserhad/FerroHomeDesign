...
public class CommonMethods extends PageInitiliazer{
	...
	public static void clickRadio(List<WebElement> elements, String radioText) {
	 ...
	 public static WebDriver HighlightElement(WebElement element){ 
	 	...
	 	public static WebDriver HighlightElementGreen(WebElement element){ 
	 	    if (driver instanceof JavascriptExecutor) {
	 	        ((JavascriptExecutor)driver).executeScript("arguments[0].style.border='10px solid green'", element);
	 	    }
	 	    return driver;
	 	}
